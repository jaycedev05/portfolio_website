...
export const HERO_INTRO =
  'Full-stack developer partnering with startups to ship products that launch, learn, and scale.'
...
export const SERVICES: Service[] = [
  {
    ...
    years: '9+ years',
    description:
      'End-to-end web and mobile products - from architecture and APIs to polished interfaces - built with clarity, performance, and maintainability in mind.',
  },
  {
    title: 'AI-Powered Products',
    years: '4+ years',
    description:
      'Claude integrations, LLM workflows, and intelligent features that feel natural in the product - not bolted on as an afterthought.',
  },
  {
    title: 'Startup Partnership',
    years: '20+ apps',
    description:
      'Hands-on product partnership for founders who need someone to move fast, communicate clearly, and own outcomes - not just close tickets.',
  },
]
...
export const STATS = [
  ...
  { value: '7', label: 'Startup Products', highlight: false },
...
export const PROJECTS: Project[] = [
  {
    ...
    techStack: ['React', 'Node.js', 'PHP', 'Laravel'],
    ...
    modalTechStack: ['React', 'Node.js', 'PHP', 'Laravel'],
  ...
  },
  {
    ...
    techStack: ['React', 'Python', 'Django', 'NestJS'],
    ...
    modalTechStack: ['React', 'Python', 'Django', 'NestJS'],
  ...
  },
  {
    ...
    tags: ['AI/ML', 'EdTech'],
    techStack: ['Python', 'FastAPI', 'Node.js', 'Next.js', 'AWS'],
    ...
    modalTechStack: ['Python', 'FastAPI', 'Node.js', 'Next.js', 'AWS'],
  ...
  },
  {
    ...
    modalTechStack: ['Flutter', 'LLM APIs', 'REST APIs', 'In-app subscriptions', 'Video lessons', 'Analytics'],
